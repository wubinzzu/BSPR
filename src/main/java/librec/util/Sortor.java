...
public class Sortor {
	...
	public static void quickSort(double[] array, int first, int last, boolean increasingOrder) {
		int pivotIndex;
	...
	private static int partition(double[] array, int first, int last, boolean increasingOrder) {
		double tmpInt;
