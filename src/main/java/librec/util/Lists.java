...
public class Lists {
	...
	public static <T> Set<T> setintersect(Set<T> list1, Set<T> list2) {
	...
	public static <T> int overlapSize(List<T> list1, Set<T> list2) {
		int res = 0;
	...
	public static <T> int setoverlapSize(List<T> list1, Set<T> list2) {
		int res = 0;
	...
	public static <T> int setexceptSize(List<T> list1, Set<T> list2) {
		int res = 0;
	...
	public static <T> int setexceptSize(Set<T> list1, Set<T> list2) {
		int res = 0;
     ...
     */
    public static <K, V extends Comparable<? super V>> void sortList(List<Map.Entry<K, V>> data, int k) {
