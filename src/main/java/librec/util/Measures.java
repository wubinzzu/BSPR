...
public class Measures {
	...
	public static <T> double AUC(List<T> rankedList, List<T> groundTruth, int num_dropped_items) {
		...
		int num_rele_items = Lists.overlapSize(rankedList,groundTruth);
	...
	public static <T> double AUC(List<T> rankedList, Set<T> groundTruth, int num_dropped_items) {
		...
		int num_miss_items = groundTruth.size()-num_rele_items;
		num_correct_pairs += hits * (num_dropped_items - num_miss_items);
